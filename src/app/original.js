...
// --- CONFIG: replace these with your real links later ---
const FAREHARBOR_BOOK_URL = "https://fareharbor.com/your-business/items/"; // TODO: drop in your real FareHarbor link
const CONTACT_EMAIL = "waikikiebikes@gmail.com"; // update when you pick your final email
    ...
    <main className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-teal-50 text-slate-800">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/60 border-b border-emerald-100">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="#experiences" className="hover:text-emerald-600">Curated Drops</a>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-600 text-lg">
              Reserve online. Scan a QR. Ride the island. We deliver to your hotel or meet at our free pickup spot near McCully & Kapiʻolani.
            </p>
          ...
          <div className="relative">
            {/* Decorative hero image — use Tailwind background utility. Mark as presentational for screen readers */}
            <div aria-hidden="true" role="presentation" className="aspect-[4/3] rounded-3xl shadow-xl bg-[url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800&auto=format&fit=crop')] bg-cover bg-center" />
            <div className="absolute -bottom-4 -left-4 bg-white/80 backdrop-blur rounded-2xl shadow p-4 flex items-center gap-3">
              <Sun className="h-5 w-5 text-amber-500"/> <span className="text-sm">Best at golden hour along Ala Moana & Diamond Head</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="rounded-3xl border-emerald-100">
            ...
            <CardContent className="space-y-4">
              <p className="text-4xl font-semibold">$90<span className="text-base font-normal text-slate-500"> / day</span></p>
              <ul className="space-y-2 text-slate-600 text-sm">
                <li>Unlimited miles</li>
                <li>Helmet, U‑lock, AirTag security</li>
                <li>Digital guide routes</li>
              </ul>
              <Button asChild className="w-full bg-emerald-600 hover:bg-emerald-700 rounded-2xl">
                <a href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">Reserve now</a>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-3xl border-emerald-100">
            ...
            <CardContent className="space-y-4">
              <p className="text-4xl font-semibold">$80<span className="text-base font-normal text-slate-500"> / day</span></p>
              <ul className="space-y-2 text-slate-600 text-sm">
              ...
              <Button asChild className="w-full bg-emerald-600 hover:bg-emerald-700 rounded-2xl">
                <a href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">See availability</a>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-3xl border-emerald-100 relative overflow-hidden">
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-600 text-sm">
                ...
                <li>Waikīkī & nearby zones</li>
                <li>Schedule at checkout</li>
              </ul>
              <Button asChild variant="outline" className="w-full rounded-2xl border-emerald-300 text-emerald-700">
                <a href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">Add delivery</a>
              </Button>
            </CardContent>
          </Card>
        </div>
      ...
      <section id="experiences" className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-900">Curated drop‑offs</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { title: "Diamond Head Lookout Cruise", blurb: "Iconic coastline views on a gentle, paved loop.", time: "2–3 hrs", id: "diamond"},
            { title: "Ala Moana ↔ Kakaʻako Art Ride", blurb: "Beach park paths and vibrant murals.", time: "1–2 hrs", id: "kakaako"},
            { title: "North Shore Haleʻiwa Town", blurb: "Flat oceanside cruiser with food trucks.", time: "Half day", id: "haleiwa"},
          ].map((x) => (
            <Card key={x.id} className="rounded-3xl border-emerald-100">
              ...
              <CardContent className="space-y-3">
                ...
                <p className="text-sm text-slate-500">Suggested time: {x.time}</p>
                <div className="flex items-center gap-3">
                  <Button asChild className="rounded-2xl bg-emerald-600 hover:bg-emerald-700">
                    <a href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">Book with drop‑off</a>
                  </Button>
                  <Button asChild variant="outline" className="rounded-2xl border-emerald-300 text-emerald-700">
                    <a href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">Just rent bikes</a>
                  </Button>
                </div>
              </CardContent>
            </Card>
      ...
      <section id="how" className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            { icon: Smartphone, title: "Unlock", text: "We text your QR+code. Bikes come with helmets & locks." },
            { icon: MapPin, title: "Ride", text: "Follow our easy, scenic routes to keep things chill." },
            { icon: Lock, title: "Return", text: "Lock up at our free pickup spot or schedule a hotel return." },
          ].map((s, i) => (
      ...
      <section id="pickup" className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-slate-900">Free pickup & return</h2>
        <p className="text-slate-600 mt-2 max-w-3xl">
          Our free pickup/return location is near the 7‑Eleven on Kapiʻolani Blvd between Pumehana & McCully. Exact pin shared after booking.
        </p>
        <div className="mt-6 grid md:grid-cols-2 gap-6 items-stretch">
          <div className="rounded-3xl overflow-hidden shadow border border-emerald-100 bg-white">
            {/* Simple map placeholder with link; replace src with your custom Google Maps link */}
            <iframe
              title="Pickup Map"
          ...
          <Card className="rounded-3xl border-emerald-100">
            <CardContent className="p-6 space-y-4">
              ...
              <div className="pt-2">
                <Button asChild className="rounded-2xl bg-emerald-600 hover:bg-emerald-700">
                  <a href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">Book pickup time</a>
                </Button>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="rounded-3xl border-emerald-100">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-slate-600 mt-1">Nope. Bookings run on our secure FareHarbor page. Just tap “Book now.”</p>
            </CardContent>
          </Card>
          <Card className="rounded-3xl border-emerald-100">
            <CardContent className="p-6">
              <h3 className="font-medium">Delivery available?</h3>
              <p className="text-sm text-slate-600 mt-1">Yes, hotel delivery is a $35 flat add‑on in Waikīkī and nearby zones.</p>
            </CardContent>
          </Card>
          <Card className="rounded-3xl border-emerald-100">
            <CardContent className="p-6">
              <h3 className="font-medium">Deposits & waivers?</h3>
              <p className="text-sm text-slate-600 mt-1">A small security hold and a digital waiver keep things smooth for everyone.</p>
            </CardContent>
          </Card>
          <Card className="rounded-3xl border-emerald-100">
            <CardContent className="p-6">
              <h3 className="font-medium">Group bookings?</h3>
              <p className="text-sm text-slate-600 mt-1">Absolutely. We have 6 foldable e‑bikes and can arrange staggered starts.</p>
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 grid md:grid-cols-3 gap-6 items-start">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">Waikiki E‑Bikes</span>
            </div>
            <p className="text-sm text-slate-600 mt-2">Minimal footprint, maximum fun. See more by e‑bike.</p>
          </div>
          <div className="text-sm">
            <div className="font-medium">Contact</div>
            <a className="block text-emerald-700 hover:underline" href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>
          </div>
          <div className="text-sm">
            <div className="font-medium">Book</div>
            <a className="block text-emerald-700 hover:underline" href={FAREHARBOR_BOOK_URL} target="_blank" rel="noreferrer">FareHarbor bookings</a>
          </div>
        </div>
        <div className="text-xs text-center text-slate-500 pb-6">© {new Date().getFullYear()} Waikiki E‑Bikes. All rights reserved.</div>
      </footer>
    </main>
  );
}
